"""
Django settings for milugar project.
...
SECRET_KEY = 'django-insecure-0q747gy#j$$-an)8trse^er(t19npkw%pla_zlg-a!qr0o)qtl'
...
WSGI_APPLICATION = 'milugar.wsgi.application'
